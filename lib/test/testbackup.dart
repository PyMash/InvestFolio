...
class DataPoint {
  ...
  DataPoint(this.month, this.investmentAmount, this.roiAmount);
                      ...
                      lineBarsData: [
                        LineChartBarData(
                          spots: dataPoints.asMap().entries.map((entry) {
                            return FlSpot(
                                entry.key.toDouble(),
                                entry.value.investmentAmount);
                          }).toList(),
                          isCurved: true,
                          gradient: LinearGradient(
                            colors: [Colors.black, Colors.blueGrey.withOpacity(0.5)],
                          ),
                          barWidth: 3,
